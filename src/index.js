...
var color           =   d3.scaleQuantize().range([
    'rgb(255,255,229)','rgb(247,252,185)','rgb(217,240,163)',
...
// Data
d3.json( 'public/zombie-attacks.json', function( zombie_data ){
    color.domain([
    ...
    d3.json( 'public/us.json', function( us_data ){
...
function draw_cities(){
    d3.json( 'public/us-cities.json', function( city_data ){
